    ...
    head () {
      return {
        ...
        meta: [
          ...
          {hid: 'og:url', name: 'og:url', content: `https://jicjjang.github.io/resume`},
          {hid: 'og:site_name', name: 'og:site_name', content: 'June'},
          {hid: 'og:description', name: 'og:description', content: 'June\'s resume'},
          {hid: 'og:image', name: 'og:image', content: 'https://jicjjang.github.io/static/image/mine.jpg'},
          ...
          {hid: 'twitter:url', name: 'twitter:url', content: `https://jicjjang.github.io/resume`},
          {hid: 'twitter:image', name: 'twitter:image', content: 'https://jicjjang.github.io/static/image/mine.jpg'},
        ],
        script: [
          ...
          { type: 'text/javascript', src: '/static/resume/script/main.js' },
        ],
        link: [
          ...
          { rel: 'stylesheet', href: '/static/resume/css/styles-2.css' },
        ]
      }
    },
  }
