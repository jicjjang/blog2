...
export const experienceContents: IResumeExperience[] = [
  {
    ...
    details: `벅스에 입사하면서 받은 오리엔테이션 후반부에 팀을 정하기 위해 면담을 하는 과정이 있었습니다. "프론트 엔드" 팀의 여부와 할 수 있는지 여부를 물어봤으나 벅스에는 웹서비스 팀만이 존재하였고, 서버 개발과 template 엔진을 붙여 사용할 수 밖에 없었습니다. 하지만 계속 원하던 것은 프론트 엔드 개발이었고 이를 적용하기 위해 팀 내에서 수 차례 프론트엔드 개발 관련 세미나를 진행하고 토이 프로젝트를 진행하였습니다. 하지만 번번히 새로운 기술에 대한 검증이 필요하다거나 미숙하다는 이유로 적용이 좌절되었습니다.<br/><br/>이를 계기로 카카오페이에 이직을 하게 되었고, 현재 원하는 프론트 개발을 마음껏 하고 있으며 기존에 많이 경험해보지 못했던 웹뷰 환경에서 많은 엣지케이스를 경험하며 (ㅠㅠ) 즐겁게 개발하고 있습니다. 현재는 투자, 펀드, 혜택 등의 프론트엔드를 담당하고 있습니다.`
  },
  {
    title: 'Web Developer',
