...
const vuePwaStart: NextPage = () => {
  return (
    ...
    <section>
      <div>
        ...
        <ul style="list-style: none; margin: 0;">
          <li class="fragment">1. 지루한 pwa 설명</li>
          <li class="fragment">2. 설치 및 개발</li>
          <li class="fragment">3. 사용하면서 어려웠던 부분</li>
          <li class="fragment">4. Push Notification</li>
    ...
    <section>
      ...
      <section>
        <h3>앱 셸이란?</h3>
        <div class="fragment" style="font-size: 32px; text-align: left;">애플리케이션 셸은 사용자 인터페이스를 지원하는 최소한의 HTML, CSS, 자바스크립트입니다. 애플리케이션 셸의 특징은 다음과 같습니다.</div>
        <br/>
        <ul class="fragment" style="font-size: 32px; width: 100%; text-align: left;">
          <li>로드 속도가 빠릅니다.</li>
          <li>캐시됩니다.</li>
          <li>콘텐츠를 동적으로 표시합니다.</li>
        </ul>
        <br/>
        <div style="font-size: 20px;" class="fragment">참고 - https://support.google.com/partners/answer/7336597?hl=ko</div>
        <aside class="notes">
      ...
      <section>
        ...
        <div class="fragment" style="font-size: 32px; text-align: left;">
          <ul>
