      ...
      <div className="slides">
            ...
            <div className="fragment">
              ...
              <div style={{ display: 'inline-block', width: '50%' }}>
                <img
                  ...
                  src="/static/slides/image/vue-pwa-start/service-worker.gif"
                />
              </div>
            </div>
            <div style={{ fontSize: '20px' }} className="fragment">
          ...
          <section>
            ...
            <div className="fragment" style={{ width: '80%', margin: '0 auto' }}>
              <img
                ...
                src="/static/slides/image/vue-pwa-start/develop.png"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              <div style={{ display: 'inline-block', width: '30%', verticalAlign: 'top' }}>
                <img
                  style={{ display: 'block', margin: '0 auto' }}
                  src="/static/slides/image/vue-pwa-start/folder1.png"
                />
              </div>
              <div style={{ display: 'inline-block', width: '30%', verticalAlign: 'top' }}>
                <img
                  style={{ display: 'block', margin: '0 auto' }}
                  src="/static/slides/image/vue-pwa-start/folder2.png"
                />
              </div>
            </div>
            <aside className="notes">
        ...
        <section>
          ...
          <section>
            ...
            <div>
              <div style={{ display: 'inline-block', width: '48%', verticalAlign: 'top' }}>
                <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code1.png" />
              </div>
              <div style={{ display: 'inline-block', width: '48%' }}>
                <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code2.png" />
              </div>
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', width: '48%', verticalAlign: 'top' }}>
              <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code3.png" />
            </div>
            <div style={{ display: 'inline-block', width: '48%' }}>
              <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code4.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', width: '48%', verticalAlign: 'top' }}>
              <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code5.png" />
            </div>
            <div style={{ display: 'inline-block', width: '48%' }}>
              <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code6.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div>
              <div style={{ display: 'inline-block', width: '48%', verticalAlign: 'top' }}>
                <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code7.png" />
              </div>
              <div style={{ display: 'inline-block', width: '48%' }}>
                <img style={{ margin: '0 10px' }} src="/static/slides/image/vue-pwa-start/code8.png" />
              </div>
            </div>
            <aside className="notes">
