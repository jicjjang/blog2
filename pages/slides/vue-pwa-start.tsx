...
const vuePwaStart: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('vue-pwa-start')}>
      <div className="slides">
        <section data-background="/static/image/javascript/vue/vuetifulkorea3_background.png">
        ...
        <section>
          <section>
            ...
            <ul className="fragment" style={{fontSize: '32px'}}>
              ...
              <li>앱과 유사 - <a href="https://github.com/google/WebFundamentals/blob/master/src/content/ko/fundamentals/architecture/app-shell.md" target="_blank">앱 셸</a>
                모드에서 작성. 앱 스타일의 동작</li>
              <li>최신 상태 - <a href="https://b.limminho.com/archives/1384" target="_blank">Service Worker</a>에 업데이트 프로세스가 있음</li>
          ...
          <section>
            <h3>앱 셸이란?</h3>
            <div className="fragment" style={{fontSize: '32px', textAlign: 'left'}}>애플리케이션 셸은 사용자 인터페이스를 지원하는 최소한의 HTML, CSS, 자바스크립트입니다. 애플리케이션 셸의 특징은 다음과 같습니다.</div>
            <br/>
            ...
            <br/>
            <div style={{fontSize: '20px'}} className="fragment">참고 - https://support.google.com/partners/answer/7336597?hl=ko</div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              ...
              <div style={{display: 'inline-block', width: '50%'}}>
                <img style={{border: 'none', margin: '0 auto'}} src="/static/slides/image/pwa/service-worker.gif" />
              </div>
            </div>
            <div style={{fontSize: '20px'}} className="fragment">참고 - https://support.google.com/partners/answer/7336697?hl=ko</div>
            <aside className="notes">
        ...
        <section>
          ...
          <section>
            ...
            <div className="fragment" style={{width:'80%', margin: '0 auto'}}>
              <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/pwa/develop.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              <div style={{display: 'inline-block', width: '30%', verticalAlign: 'top'}}>
                <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/pwa/folder1.png" />
              </div>
              <div style={{display: 'inline-block', width: '30%', verticalAlign: 'top'}}>
                <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/pwa/folder2.png" />
              </div>
            </div>
            <aside className="notes">
      ...
      .then(windowClients => {
        for (let windowClient of windowClients) {
          ...
          <section>
            ...
            <div style={{display: 'inline-block', width: "48%"}}>n: 'top'}}>
              <pre><code data-trim data-noescape style={{fontSize: '15px'}}>
    {`
    ...
    new CopyWebpackPlugin([
      ...
      },
      {
          ...
          <section>
            ...
            <div>
              <ol style={{fontSize: '32px'}}>
                <li className="fragment">기본적으로 자신의 앱 코드 안에 서비스 워커를 등록 시켜주는 register 부분이 있어야 하고,
                  등록 될 Service Worker 파일이 있어야 한다.</li>
                <li className="fragment">그러나 vue-pwa-template 의 dev 버전에서는 register 부분이 따로 없다.</li>
                <li className="fragment">Production 모드에서는 register 부분이 있으나,
                  서비스 워커를 자동으로 생성해주는 부분만 있다. (커스텀 시, 설정이 필요)</li>
                <li className="fragment">Production 모드에서 사용하려면 webpack설정을 조금 바꿔줘야 하는데
                  문서가 쪼오금... 친절하진 않음.</li>
              </ol>
            </div>
        ...
        <section>
          ...
          <div className="fragment" style={{textAlign: 'left'}}>사실 Vue에서의 세팅을 마치고 튜토리얼대로 하면 끝!</div>
          <div className="fragment" style={{textAlign: 'left'}}>튜토리얼에서 알려주는대로 Service Worker에 Event를 등록해주세요.</div>
        </section>
