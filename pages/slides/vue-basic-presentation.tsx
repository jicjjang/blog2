...
const vueBasicPresentation: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('vue-basic-presentation')}>
      <div className="slides">
        ...
        <section>
          ...
          <section>
            ...
            <div className="fragment" style={{ display: 'inline-block', width: '35%' }}>
              <img src="/static/slides/image/vue-basic/compare1.png" />
            </div>
            <div style={{ display: 'inline-block', width: '50%' }}>
              <img className="fragment" src="/static/slides/image/vue-basic/compare2.png" />
              <img className="fragment" src="/static/slides/image/vue-basic/compare3.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment" style={{ width: '50%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/good.jpg" />
            </div>
        ...
        <section>
          ...
          <section>
            <div style={{ width: '50%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/helloworld.png" />
            </div>
        ...
        <section>
          <section>
            <div style={{ width: '50%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/ricebot.png" />
            </div>
          ...
          <section>
            <div style={{ width: '70%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/example1.png" />
            </div>
            <aside className="notes">템플릿, 컴포넌트 부분입니다. data가 파싱된 html부분입니다.</aside>
          </section>
          <section>
            <div style={{ width: '50%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/example2.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            <div style={{ width: '40%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/example3.png" />
            </div>
            <aside className="notes">
          ...
          <section>
            <div style={{ width: '60%', margin: '0 auto' }}>
              <img src="/static/slides/image/vue-basic/hooker.png" />
            </div>
        ...
        <section>
          <div style={{ width: '50%', margin: '0 auto' }}>
            <img src="/static/slides/image/vue-basic/end.jpg" />
          </div>
          <h1>끝</h1>
        </section>
      </div>
...
export default vueBasicPresentation;
