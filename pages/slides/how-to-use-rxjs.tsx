...
const howToUseRxjs: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('how-to-use-rxjs')}>
      {/* <div class="slides">
    ...
    <section>
      <div>
        ...
        <ul style="list-style: none; margin: 0;">
          <li class="fragment">1. Rx란 뭔가요?</li>
          <li class="fragment">2. 간단한 예제</li>
          <li class="fragment">3. 우리의 현재와 미래</li>
    ...
    <section>
      ...
      <section>
        ...
        <div style="display: inline-block; margin: 0 20px;" class="fragment">
          <img style="background: none; border: none; box-shadow: none;" src="/blog/static/slides/image/rxjs/arrow_right_down.png">
          <div style="text-align: right;">Data Flow</div>
        </div>
        <aside class="notes">
      ...
      <section>
        ...
        <div class="fragment">
          ...
          <div class="fragment fade-in">
            ...
            <div style="display: inline-block; margin: 0 20px;" class="fragment">
              <img style="background: none; border: none; box-shadow: none;" src="/blog/static/slides/image/rxjs/arrow_down.png">
              <div style="text-align: center;">Observer</div>
            </div>
            <div style="display: inline-block; margin: 0 20px;" class="fragment">
              <img style="background: none; border: none; box-shadow: none;" src="/blog/static/slides/image/rxjs/arrow_right_down.png">
              <div style="text-align: right;">Subscribe</div>
            </div>
          </div>
        </div>
        <aside class="notes">
      ...
      <section>
        <h3>요약하자면</h3>
        <ul>
          <li class="fragment">Rx는 Event stream과 Data를 쉽게 컨트롤하도록 도와줌</li>
          <li class="fragment">가독성 좋은 비동기 코드를 체이닝으로 쉽게 작성 가능</li>
          <li class="fragment">초기 진입장벽이 어느 정도 존재한다는 단점이 있음</li>
        </ul>
        <aside class="notes">
    ...
    <section>
      <section>
        <h2>2. 간단한 예제</h2>
        <h3 class="fragment">Rx의 종류</h3>
        <div>
          <span class="fragment">RxJava, </span>
          <span class="fragment">RxJs, </span>
          <span class="fragment">Rx.Net, </span>
          <span class="fragment">RxScala, </span>
      ...
      <section>
        <h2>RxJs 예제</h2>
        <div><a href="https://jsfiddle.net/junseokchoi/Lsm48mpd/10/" target="_blank">https://jsfiddle.net/junseokchoi/Lsm48mpd/</a></div>
      </section>
    </section>
    ...
    <section>
      <section>
        <h2>3. 우리의 현재와 미래</h2>
        <h3 class="fragment">왜 RxJs로 눈을 돌리게 되었나?</h3>
        <ul>
          <li class="fragment">Callback hell이 일어나는 부분이 많음</li>
          <li class="fragment">Promise와 Async/Await에 대한 부재 (ECMA 버전 이슈)</li>
          <li class="fragment">jQuery에 있는 Deffered라도... <br/>(보안상 이슈가 생길 수 있어서 X)</li>
        </ul>
        <aside class="notes">
    ...
    <section>
      ...
      <section>
        ...
        <div>
          <div><a style="font-size: 30px;" href="https://www.slideshare.net/sunhyouplee/vuejs-reactive-programming-vuetiful-korea-2nd" target="_blank">https://www.slideshare.net/sunhyouplee/vuejs-reactive-programming-vuetiful-korea-2nd</a></div>
          <div><a style="font-size: 30px;" href="http://sculove.github.io/blog/2016/06/22/Reactive-Programming/" target="_blank">http://sculove.github.io/blog/2016/06/22/Reactive-Programming/</a></div>
          <div><a style="font-size: 30px;" href="https://github.com/CoderK/What-I-Learned-About-RP/blob/master/README.md#rx와-리액티브-프로그래밍2016" target="_blank">https://github.com/CoderK/What-I-Learned-About-RP/blob/master/README.md#rx와-리액티브-프로그래밍2016</a></div>
          <div><a style="font-size: 30px;" href="https://github.com/studye/rxjs/wiki/Chapter-1.-The-Reactive-Way" target="_blank">https://github.com/studye/rxjs/wiki/Chapter-1.-The-Reactive-Way</a></div>
        </div>
      </section>
    </section>
