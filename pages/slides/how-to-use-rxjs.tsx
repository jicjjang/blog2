        ...
        <section>
          <section>
            ...
            <div className="fragment" style={{ width: '70%', margin: '0 auto' }}>
              <img style={{ display: 'block', margin: '5px auto' }} src="/static/slides/image/rxjs/intro1.jpg" />
              <img style={{ display: 'block', margin: '5px auto' }} src="/static/slides/image/rxjs/intro1_trans.jpg" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment" style={{ width: '100%', margin: '0 auto' }}>
              <img
                ...
                src="/static/slides/image/rxjs/example.jpg"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment" style={{ maxWidth: '100%', margin: '0 auto' }}>
              <img
                style={{ display: 'block', width: '60%', margin: '0 auto' }}
                src="/static/slides/image/rxjs/excel.jpg"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', margin: '0 20px' }} className="fragment">
              <img
                ...
                src="/static/slides/image/rxjs/arrow_left_down.png"
              />
            ...
            <div style={{ display: 'inline-block', margin: '0 20px' }} className="fragment">
              <img
                style={{ background: 'none', border: 'none', boxShadow: 'none' }}
                src="/static/slides/image/rxjs/arrow_right_down.png"
              />
            ...
            <div className="fragment">
              <div className="fragment fade-out" style={{ position: 'absolute' }}>
                <div style={{ display: 'inline-block', width: '40%', margin: '0 1%' }}>
                  <img
                    ...
                    src="/static/slides/image/rxjs/observer.jpg"
                  />
                ...
                <div style={{ display: 'inline-block', width: '40%', margin: '0 1%', verticalAlign: 'top' }}>
                  <img
                    style={{ display: 'block', width: '100%', margin: '0 auto' }}
                    src="/static/slides/image/rxjs/rx_observer.jpg"
                  />
                </div>
              </div>
              <div className="fragment fade-in">
                ...
                <div style={{ display: 'inline-block', margin: '0 20px' }} className="fragment">
                  <img
                    style={{ background: 'none', border: 'none', boxShadow: 'none' }}
                    src="/static/slides/image/rxjs/arrow_down.png"
                  />
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', maxWidth: '400px', verticalAlign: 'top', margin: '0 20px' }}>
              ...
              <img
                ...
                src="/static/slides/image/rxjs/youtube_live.jpg"
              />
            </div>
            ...
            <div style={{ display: 'inline-block', maxWidth: '400px', verticalAlign: 'top', margin: '0 20px' }}>
              ...
              <img
                ...
                style={{ display: 'block', margin: '0 auto' }}
                src="/static/slides/image/rxjs/youtube.jpg"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment" style={{ width: '100%', margin: '0 auto' }}>
              <img
                ...
                src="/static/slides/image/rxjs/support.jpg"
              />
            </div>
            <aside className="notes">
