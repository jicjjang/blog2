...
const reactBasic: NextPage = () => {
  return (
    ...
    <section>
      <p>시작은 페이스북 &amp; 인스타그램 개발자들의 View에만 집중된 프레임워크를 블라블라....(생략)</p><br/>
      <h2 class="fragment"><a href="https://facebook.github.io/react/blog/2013/06/05/why-react.html">"지속해서 데이터가 변화하는 대규모 애플리케이션을 구축하기" 용도</a></h2>
      <aside class="notes">
    ...
    <section>
      ...
      <section>
        ...
        <aside class="notes">
          SPA앱에서 사용자가 끊임없이 data를 가져오고, 현재 상태를 확인해서 data-binding을 해줘야 하는데 이 과정은 프로젝트가 커질수록 복잡해집니다.<br />
    ...
    <section>
      ...
      <h3 class="fragment">어라?</h3>
      <p class="fragment">그렇다면 state와 props는<br />각각의 컴포넌트가 모두 들고있는 건가?</p>
      <h2 class="fragment">ㅇㅇ</h2>
      <aside class="notes">
