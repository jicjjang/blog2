...
const reactBasic: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('react-basic')}>
      <div className="slides">
        ...
        <section>
          ...
          <section>
            ...
            <p style={{ width: '60%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/component.png" />
            </p>
          ...
          <section>
            ...
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/component_example.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            ...
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/tree.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            <h2>Flux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/mvc.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            <h2>Flux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/flux.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            <h2>Flux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/flux1.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            <h2>Flux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/flux2.png" />
            </p>
          ...
          <section>
            <h2>Redux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/redux1.png" />
            </p>
            <aside className="notes">
          ...
          <section>
            <h2>Redux</h2>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/redux2.png" />
            </p>
            <aside className="notes">
        ...
        <section>
          ...
          <p style={{ width: '60%', margin: '0 auto' }} className="fragment">
            <img src="/static/slides/image/react-basic/develop.png" />
          </p>
    ...
    return (
      <a onClick={this.increase.bind(this)}>Click me!</a>
          ...
          <section style={{ fontSize: '28px' }}>
            ...
            <h3>3. Life Cycle</h3>
            <p style={{ width: '80%', margin: '0 auto' }}>
              <img src="/static/slides/image/react-basic/lifecycle.png" />
            </p>
        ...
        <section>
          <section>
            ...
            <p style={{ width: '80%', margin: '0 auto' }} className="fragment">
              <img src="/static/slides/image/react-basic/withRedux.png" />
