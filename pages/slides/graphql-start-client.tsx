...
const graphqlStartClient: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('graphql-start-client')}>
          ...
          <section>
            ...
            <div>
              <div className="fragment" style={{ display: 'inline-block', width: '40%' }}>
                <img src="/static/slides/image/graphql-start/apollo-provider.png" />
              </div>
...
export default graphqlStartClient;
