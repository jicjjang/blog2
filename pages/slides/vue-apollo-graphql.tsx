...
const vueApolloGraphql: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('vue-apollo-graphql')}>
      <div className="slides">
        <section data-background="/static/image/javascript/vue/vuetifulkorea4_background.png">
        ...
        <section>
          ...
          <section>
            ...
            <div style={{fontSize: '30px'}}>
              <div className="fragment" style={{display: 'inline-block', width: '20%', paddingLeft: '1%', paddingRight: '1%', marginLeft: '1%', verticalAlign: 'top', borderLeft: '1px solid #fff', borderRight: '1px solid #fff'}}>GraphQL에서 `RDB`가 나을까 `NoSQL`이 나을까?</div>
              <div className="fragment" style={{display: 'inline-block', width: '20%', paddingLeft: '1%', paddingRight: '1%', marginLeft: '1%', verticalAlign: 'top', borderLeft: '1px solid #fff', borderRight: '1px solid #fff'}}>보통 DB에서 성능에 영향을 많이 주더라도 사용하게 되는 JOIN... 하지만 JOIN이 힘든 NoSql에서 쿼리가 급격히 늘어날수도...</div>
              <div className="fragment" style={{display: 'inline-block', width: '20%', paddingLeft: '1%', paddingRight: '1%', marginLeft: '1%', verticalAlign: 'top', borderLeft: '1px solid #fff', borderRight: '1px solid #fff'}}>RDB가 나쁠 이유는 없는데?</div>
              <div className="fragment" style={{display: 'inline-block', width: '20%', paddingLeft: '1%', paddingRight: '1%', marginLeft: '1%', verticalAlign: 'top', borderLeft: '1px solid #fff', borderRight: '1px solid #fff'}}>심지어 각각의 클라이언트에서 Depth에 대한 난이도 조절 가능...!</div>
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{width: '90%', margin: '0 auto'}}>
              <span style={{display: 'inline-block', width: '58%', margin: '5px',verticalAlign: 'top'}}>
                <img className="fragment" data-fragment-index="1" src="/static/slides/image/graphql-start/about1.jpg" style={{margin: '0 auto'}}/>
                <div className="fragment" style={{marginTop: '20px', fontSize: '20px'}} data-fragment-index="3">필요한 것만 정확히 물어볼 수있는 기능을 제공하며 시간이 지남에 따라 API를 쉽게 개발할 수 있도록...</div>
              </span>
              <span style={{display: 'inline-block', width: '38%', margin: '5px'}}>
                <img className="fragment" data-fragment-index="2" src="/static/slides/image/graphql-start/about2.jpg" style={{margin: '0 auto'}}/>
                <div className="fragment" style={{marginTop: '20px', fontSize: '20px'}} data-fragment-index="4">GraphQL은 단독 버전 관리를 통해 기존 코드 수정없이 보다 깨끗하고 유지보수가 쉽게 사용이 가능...</div>
              </span>
            </div>
            <aside className="notes">
        ...
        <section>
            ...
            <div style={{fontSize: '32px'}} className="fragment">
              <div style={{display: 'inline-block', width: '50%', textAlign: 'center'}}>
                ...
                <div style={{width: '60%', maxWidth: '580px', margin: '0 auto', verticalAlign: 'top'}}>
                  <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/vue-apollo-graphql/query_api.png" />
                </div>
              </div>
              <div style={{display: 'inline-block', width: '50%', textAlign: 'center', verticalAlign: 'top'}}>
                ...
                <div style={{width: '60%', maxWidth: '580px', margin: '0 auto', verticalAlign: 'top'}}>
                  <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/vue-apollo-graphql/query_graphql.png" />
                </div>
              </div>
            </div>
            <aside className="notes">
          ...
          <section>
            <h3>서버는 살짝만</h3>
            <div className="fragment" data-fragment-index="1" style={{fontSize: '32px'}}>하기에는... 생각보단 쉬워요! (클라이언트보단)</div>
            ...
            <div className="fragment" data-fragment-index="2">어떤 부분이 달라졌는지 확인해봅시다.</div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{display: 'inline-block', width: '40%', verticalAlign: 'top'}}>
              ...
              <div className="fragment"  style={{margin: '20px auto 0 auto'}}>
                <img style={{display: 'block', margin: '0 auto'}} src="/static/slides/image/vue-apollo-graphql/graphiql.png" />
              </div>
            </div>
            <aside className="notes">
        ...
        <section>
          <section>
            <h2>3. Client</h2>
            <div className="fragment" data-fragment-index="1" style={{fontSize: '32px'}}>클라이언트도 서버처럼</div>
            <div className="fragment" data-fragment-index="2" style={{marginTop: '20px'}}>
            ...
            <div className="fragment" data-fragment-index="2">어떻게 바꾸는지 알아봅시다.</div>
            <aside className="notes">
        ...
        <section>
          ...
          <section>
            <h2>주관적인(겪어봤던) 리뷰</h2>
              <div style={{marginTop: '40px'}}>
                <div className="fragment" style={{display: 'inline-block', width: '18%', margin: '1%', fontSize: '30px', verticalAlign: 'top'}}>실제로 구현하는건 훨씬 복잡한 케이스가 다수</div>
                <div className="fragment" style={{display: 'inline-block', width: '18%', margin: '1%', fontSize: '30px', verticalAlign: 'top'}}>에러 관리 (에러가 200으로 떨어지는 케이스)</div>
                <div className="fragment" style={{display: 'inline-block', width: '18%', margin: '1%', fontSize: '30px', verticalAlign: 'top'}}>실패한 요청에 대한 재시도 (pub/sub으로 해결 가능함)</div>
                <div className="fragment" style={{display: 'inline-block', width: '18%', margin: '1%', fontSize: '30px', verticalAlign: 'top'}}>하지만! 어느정도 잡혀있는 규칙에 대해선 매우 긍정적</div>
                <div className="fragment" style={{display: 'inline-block', width: '18%', margin: '1%', fontSize: '30px', verticalAlign: 'top'}}>러닝커브는 모르겠지만, 한번 익숙해지면 rest보다 낫다고 생각할 수 밖에 없음</div>
              </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              ...
              <b style={{display: 'block', marginTop: '40px', fontSize: '50px', color: '#efdcbc'}} className="fragment">신규서비스라면 써보라 추천!!</b>
            </div>
            <aside className="notes">
...
export default vueApolloGraphql;
