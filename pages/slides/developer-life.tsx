...
const developerLife: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('developer-life')}>
      <div className="slides">
          ...
          <div>
            ...
            <div
              ...
              <img
                ...
                src="/static/slides/image/oss/me.jpg"
              />
              <img
                className="fragment fade-up"
                data-fragment-index="3"
                style={{ width: '500px', margin: '0' }}
                src="/static/slides/image/oss/conert.jpg"
              />
            </div>
        ...
        <section>
          <section>
            ...
            <div className="fragment" style={{ display: 'inline-block', verticalAlign: 'top' }}>
              ...
              <img src="/static/slides/image/oss/jjal1.jpg" />
            ...
            <div className="fragment" style={{ display: 'inline-block' }}>
              <h4>최모씨의 20살</h4>
              <img src="/static/slides/image/oss/jjal2.jpg" />
              <div style={{ fontSize: '15px' }}>출처 - 네이버 웹툰 &lt;대학일기&gt;</div>
            </div>
            <aside className="notes">
          ...
          <section>
            <div>
              ...
              <div className="fragment fade-up" style={{ position: 'absolute', width: '100%', margin: '0 auto' }}>
                <img style={{ display: 'block', margin: 'auto' }} src="/static/slides/image/oss/billiards.jpg" />
              </div>
              <div className="fragment fade-up" style={{ position: 'absolute', width: '100%', margin: '0 auto' }}>
                <img style={{ display: 'block', margin: 'auto' }} src="/static/slides/image/oss/jjal3.jpg" />
          ...
          <section>
            <div>
              ...
              <div className="fragment" style={{ width: '80%', margin: '0 auto' }}>
                <img style={{ display: 'block', margin: '0 auto' }} src="/static/slides/image/oss/mil.jpg" />
              </div>
            </div>
            <aside className="notes">
          ...
          <section>
            <div>
              ...
              <div className="fragment" style={{ width: '80%', margin: '0 auto' }}>
                <img style={{ display: 'block', margin: '0 auto' }} src="/static/slides/image/oss/jjal4.jpg" />
            ...
            <div>
              ...
              <div className="fragment fade-up">
                <img
                  ...
                  src="/static/slides/image/oss/parangsae1.jpg"
                />
                <img
                  style={{ width: '50%', margin: '0 5%', display: 'inline-block' }}
                  src="/static/slides/image/oss/parangsae2.jpg"
                />
              </div>
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '80%', margin: '0 auto' }} src="/static/slides/image/oss/mypi.png" />
            </div>
            <aside className="notes">
              엥?? 24살에 무슨 졸업 프로젝트???
              <br />
          ...
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '80%', margin: '0 auto' }} src="/static/slides/image/oss/tastelab1.jpg" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '80%', margin: '0 auto' }} src="/static/slides/image/oss/jjal6.jpg" />
          ...
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '50%', margin: '0 auto' }} src="/static/slides/image/oss/competition.jpg" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '50%', margin: '0 auto' }} src="/static/slides/image/oss/sosanara.jpg" />
            </div>
            <aside className="notes">
        ...
        <section>
          <section>
            ...
            <div className="fragment">
              <img style={{ width: '40%', margin: '0 auto' }} src="/static/slides/image/oss/jjal11.jpg" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', width: '40%', margin: '0 2%', verticalAlign: 'top' }}>
              <img className="fragment" src="/static/slides/image/oss/mclang1.jpg" />
              <img className="fragment" src="/static/slides/image/oss/mclang3.jpg" />
            </div>
            <div className="fragment" style={{ display: 'inline-block', width: '40%', margin: '0 2%' }}>
              <img src="/static/slides/image/oss/mclang2.jpg" />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div>
              <img
                ...
                src="/static/slides/image/oss/archiver.gif"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div>
              <img
                className="fragment"
                style={{ width: '50%', margin: '0 auto' }}
                src="/static/slides/image/oss/vue-card-layer.gif"
              />
            </div>
            <aside className="notes">
          ...
          <section>
            ...
            <div className="fragment fade-out" data-fragment-index="2" style={{ position: 'absolute', width: '100%' }}>
              <img
                ...
                src="/static/slides/image/oss/dooray1.jpg"
              />
              <img
                className="fragment"
                data-fragment-index="1"
                style={{ display: 'inline-block', width: '30%', margin: '0 1%' }}
                src="/static/slides/image/oss/dooray2.jpg"
              />
              <img
                className="fragment"
                data-fragment-index="1"
                style={{ display: 'inline-block', width: '30%', margin: '0 1%' }}
                src="/static/slides/image/oss/dooray3.jpg"
              />
            </div>
            <div className="fragment fade-up" style={{ width: '100%' }} data-fragment-index="3">
              <img src="/static/slides/image/oss/dooray4.jpg" />
            </div>
          ...
          <section>
            ...
            <div className="fragment" style={{ width: '100%' }}>
              <img
                ...
                src="/static/slides/image/oss/jjal7.jpg"
              />
              <img
                className="fragment fade-up"
                style={{ width: '60%', margin: '0 auto' }}
                src="/static/slides/image/oss/jjal8.jpg"
              />
            </div>
            <aside className="notes">
            ...
            <div>
              ...
              <div className="fragment">
                <img
                  ...
                  src="/static/slides/image/oss/jjal9.jpg"
                />
          ...
          <section style={{ paddingTop: '0', top: '130.5px' }}>
            ...
            <div>
              ...
              <img
                ...
                src="/static/slides/image/oss/arrow.png"
              />
        ...
        <section>
          <section>
            ...
            <div style={{ width: '100%', margin: '0 auto' }}>
              <img
                ...
                src="/static/slides/image/oss/jjal10.jpg"
              />
              <div style={{ fontSize: '15px' }}>출처 - 어드벤처 타임</div>
            </div>
          </section>
          <section>
            ...
            <div className="fragment" style={{ width: '100%', margin: '0 auto' }}>
              <img
                style={{ display: 'block', width: '50%', margin: '0 auto' }}
                src="/static/slides/image/oss/search1.jpg"
              />
            </div>
          </section>
          <section>
            ...
            <div className="fragment" style={{ display: 'inline-block', width: '40%', margin: '0 2%' }}>
              <img src="/static/slides/image/oss/roadmap.jpg" />
            </div>
          </section>
        </section>
