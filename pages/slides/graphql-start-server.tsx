...
const graphqlStartServer: NextPage = () => {
  return (
    <SlidesLayout slide={postsStore.getItem('graphql-start-server')}>
      <div className="slides">
        ...
        <section>
          <section>
            ...
            <div style={{ width: '90%', margin: '0 auto' }}>
              <span style={{ display: 'inline-block', width: '58%', margin: '5px', verticalAlign: 'top' }}>
                <img className="fragment" data-fragment-index="1" src="/static/slides/image/graphql-start/about1.jpg" />
              ...
              <span style={{ display: 'inline-block', width: '38%', margin: '5px' }}>
                <img className="fragment" data-fragment-index="2" src="/static/slides/image/graphql-start/about2.jpg" />
          ...
          <section>
            ...
            <div style={{ display: 'inline-block', width: '45%', verticalAlign: 'top' }}>
              <img className="fragment" data-fragment-index="1" src="/static/slides/image/graphql-start/apollo1.png" />
            ...
            <div style={{ display: 'inline-block', width: '50%' }}>
              <img className="fragment" data-fragment-index="2" src="/static/slides/image/graphql-start/apollo2.png" />
            </div>
            <aside className="notes">
              3/3
              <br />
        ...
        <section>
          ...
          <section>
            <h3>사용 중인 기업</h3>
            <div className="fragment" style={{ display: 'inline-block', width: '50%', verticalAlign: 'top' }}>
              <img src="/static/slides/image/graphql-start/users.png" />
              <div style={{ fontSize: '20px' }}>
          ...
          <section>
            <h3>컨퍼런스</h3>
            <div className="fragment" style={{ display: 'inline-block', width: '50%', verticalAlign: 'top' }}>
              <img src="/static/slides/image/graphql-start/conference.png" />
